class LakersController < ApplicationController
  ...
  def twitter
    client = Twitter::REST::Client.new do |config|
      config.consumer_key        = ENV["KbuxyRVsrpJv82NbaKmYXA"]
      config.consumer_secret     = ENV["nqpfMb0vL5qODyxEhXNNib7WyD0O1ySimV9ZzCmsEI"]
      config.access_token        = ENV["KPueiaLKfuG9Ep77Uu4UnznhpdEGkrqaC9zOYCmQoq"]
      config.access_token_secret = ENV["sRPl21ZDjdEiVnQU8Fs2OxElbXUzM2T5LrlyZJg9Lef4C"]
    end
